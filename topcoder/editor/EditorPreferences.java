...
public class EditorPreferences {
	...
	public EditorPreferences(Observer notify) {
		this.notify = notify;
	...
	public String getJAVATemplate() {
		return getStringProperty(
				"fileeditor.config.javatemplate",
	...
	public final String getCSHARPTemplate() {
		return getStringProperty(
				"fileeditor.config.csharptemplate",
	...
	public String getBeginCut() {
		return getStringProperty("fileeditor.config.beginCut",
				"// BEGIN CUT HERE");
	}
	...
	public String getProblemDescExtension() {
		return getStringProperty("fileeditor.config.probdescfileextnsion",
				"txt");
	}
	...
	public void setCPPTemplate(String template) {
		pref.setProperty("fileeditor.config.cpptemplate", template);
	}

	public void setCSHARPTemplate(String template) {
		pref.setProperty("fileeditor.config.csharptemplate", template);
	}

	public void setJAVAExtension(String extension) {
		pref.setProperty("fileeditor.config.javaextension", extension);
	}

	public void setCPPExtension(String extension) {
		pref.setProperty("fileeditor.config.cppextension", extension);
	}

	public void setCSHARPExtension(String extension) {
		pref.setProperty("fileeditor.config.csharpextension", extension);
	}

	public void setDirectoryName(String text) {
		pref.setProperty("fileeditor.config.dirName", text);
	}

	public void setFileName(String text) {
		pref.setProperty("fileeditor.config.fileName", text);
	}

	public void setBeginCut(String text) {
		pref.setProperty("fileeditor.config.beginCut", text);
	}

	public void setEndCut(String text) {
		pref.setProperty("fileeditor.config.endCut", text);
	}

	public void setSignatureFileName(String text) {
		pref.setProperty("fileeditor.config.signaturefilename", text);
	}

	public void setProblemDescExtension(String text) {
		pref.setProperty("fileeditor.config.probdescfileextnsion", text);
	}

	public void setOverrideFileName(boolean override) {
		pref.setProperty("fileeditor.config.overrideFileName",
				override ? "true" : "false");
	}

	public void setProvideBreaks(boolean provideBreaks) {
		pref.setProperty("fileeditor.config.provideBreaks",
				provideBreaks ? "true" : "false");
	}

	public void setLineComments(boolean lineComments) {
		pref.setProperty("fileeditor.config.lineComments",
				lineComments ? "true" : "false");
	}

	public void setWriteProblemDescFile(boolean probDescFile) {
		pref.setProperty("fileeditor.config.probdescfilewrite",
				probDescFile ? "true" : "false");
	}

	public void setHTMLDesc(boolean htmlDesc) {
		pref.setProperty("fileeditor.config.htmldesc", htmlDesc ? "true"
				: "false");
	}

	public void setBackup(boolean backup) {
		pref.setProperty("fileeditor.config.backup", backup ? "true" : "false");
	}

	public void setBreakAt(int breakAt) {
		pref.setProperty("fileeditor.config.breakAt", String.valueOf(breakAt));
	}
	...
	public static void main(String[] args) {
		EditorPreferences pref = new EditorPreferences();
